...
#
#	Usage: 	python gls_arb_filt.py "gls_info_cabana_logfile.csv" "123" "456" ...
#		"gls_info_cabana_logfile.csv" = the file to decode 
#		"123" = first id to filter 
#		"456" = second id to filter 
# 		etc.. 
#
#	Output: arb_filt_gls_info_cabana_logfile.csv 
...
if len(sys.argv) < 3:
	sys.exit("please specify arb ids to filter")
...
new_log = open("arb_filt_" + filename, "w+")							
